...
\newcommand{\figcl}[4]{\begin{figure}\centering\includegraphics[height={#2}\textheight]{#1}\caption{#3}\label{#4}\end{figure}}
\newcommand{\figpcl}[4]{\begin{figure}\centering\includegraphics[width={#2}\textheight, angle=-90]{#1}\caption{#3}\label{#4}\end{figure}}
...
\newcommand{\wrapfigcl}[4]{\begin{wrapfigure}{r}{{#2}\textwidth}\centering\includegraphics[width={#2}\textwidth]{#1}\caption{#3}\label{#4}\end{wrapfigure}}
\newcommand{\wrapfiglcl}[4]{\begin{wrapfigure}{r}{{#2}\textwidth}\centering\includegraphics[height={#2}\textwidth, angle=-90]{#1}\caption{#3}\label{#4}\end{wrapfigure}}
